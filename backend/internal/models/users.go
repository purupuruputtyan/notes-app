...
type User struct {
	...
	IconImage    null.String `boil:"icon_image" json:"icon_image,omitempty" toml:"icon_image" yaml:"icon_image,omitempty"`
...
var UserWhere = struct {
	...
	IconImage    whereHelpernull_String
	IsActive     whereHelperbool
	CreatedAt    whereHelpertime_Time
	UpdatedAt    whereHelpertime_Time
}{
	ID:           whereHelperstring{field: "\"users\".\"id\""},
	NickName:     whereHelperstring{field: "\"users\".\"nick_name\""},
	Email:        whereHelperstring{field: "\"users\".\"email\""},
	PasswordHash: whereHelperstring{field: "\"users\".\"password_hash\""},
	IconImage:    whereHelpernull_String{field: "\"users\".\"icon_image\""},
...
func (o *User) GetNotes() NoteSlice {
	if o == nil {
		return nil
	}
...
func (r *userR) GetNotes() NoteSlice {
	if r == nil {
		return nil
	}
...
var (
	userAllColumns            = []string{"id", "nick_name", "email", "password_hash", "icon_image", "is_active", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"id", "nick_name", "email", "password_hash"}
	userColumnsWithDefault    = []string{"icon_image", "is_active", "created_at", "updated_at"}
...
func (o *User) Notes(mods ...qm.QueryMod) noteQuery {
...
func (userL) LoadNotes(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser any, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`notes`),
		qm.WhereIn(`notes.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddNotes(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Note) error {
	var err error
